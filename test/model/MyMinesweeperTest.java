...
public class MyMinesweeperTest {
    ...
    public void checkException() {
        ...
        } catch (MyInvalidRangeException e) { fail("No InvalidRangeException expected"); }

        try {
            MyMinesweeper game = new MyMinesweeper(-1,5);
            fail("Expected an InvalidRangeException to be thrown");
        } catch (MyInvalidRangeException e) { }  // This exception was expected
    ...
    @Test
    public void getWidth() throws MyInvalidRangeException {
        MyMinesweeper game = new MyMinesweeper(6,4);
        assertEquals(4,game.getWidth());
    }

    @Test
    public void getHeight() throws MyInvalidRangeException {
        MyMinesweeper game = new MyMinesweeper(6,4);
        assertEquals(6,game.getHeight());
    }

    @Test
    public void getValueAt() throws MyInvalidRangeException {
    ...
    @Test
    public void checkLocation() throws MyInvalidRangeException {
        MyMinesweeper game = new MyMinesweeper(3,4, 1);
    ...
    @Test
    public void flagLocation() throws MyInvalidRangeException {
    ...
    @Test
    public void getNrOfActions() throws MyInvalidRangeException {
    ...
    @Test
    public void getNrOfMinesLeft() throws MyInvalidRangeException {
        MyMinesweeper game = new MyMinesweeper(7,5, 3);
        game.checkLocation(new MyLocation(3,3));
    ...
    @Test
    public void getLost() throws MyInvalidRangeException {
         for (int row=0;row<7;row++) {
             for(int col=0;col<5;col++) {
                 MyMinesweeper game = new MyMinesweeper(7,5, 3);
                 game.checkLocation(new MyLocation(row,col));
